...
static void DrawOnCanvas(Canvas *canvas) {
   ...
   */
    ...
    canvas->SetPixel(5,1,255, 0, 0);
    canvas->SetPixel(5,2,255, 0, 0);
    canvas->SetPixel(5,3,255, 0, 0);
    canvas->SetPixel(5,4,255, 0, 0);
    canvas->SetPixel(5,5,255, 0, 0);
    canvas->SetPixel(6,1,255, 0, 0);
    canvas->SetPixel(6,3,255, 0, 0);
    canvas->SetPixel(6,5,255, 0, 0);
    ...
    canvas->SetPixel(10,5,255, 0, 0);
    canvas->SetPixel(11,5,255, 0, 0);
    ...
    canvas->SetPixel(18,1,255, 0, 0);
    canvas->SetPixel(18,5,255, 0, 0);
    canvas->SetPixel(19,1,255, 0, 0);
    canvas->SetPixel(19,2,255, 0, 0);
    canvas->SetPixel(19,3,255, 0, 0);
    canvas->SetPixel(19,4,255, 0, 0);
    canvas->SetPixel(19,5,255, 0, 0);
  while(1){
  }
